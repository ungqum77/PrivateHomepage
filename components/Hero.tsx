...
const Hero = () => {
  return (
    <section className="min-h-[819px] flex flex-col md:flex-row items-center px-8 md:px-20 py-20 gap-16 overflow-hidden">
      ...
      <div className="flex-1 relative w-full h-[500px] md:h-[700px] grayscale contrast-125">
        <img
