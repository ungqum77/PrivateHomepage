    ...
    <section className="px-8 md:px-20 py-32 bg-surface-container-lowest">
      <div className="max-w-6xl mx-auto">
        <div className="mb-16">
          ...
          <h2 className="text-4xl md:text-6xl font-bold tracking-tight mt-4 uppercase">이커머스 비즈니스 전문성.</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          <div className="md:col-span-8 h-[400px] bg-surface-container border border-white/5 p-12 flex flex-col justify-end group cursor-pointer overflow-hidden relative">
            ...
            <div className="relative z-10">
              <h3 className="text-3xl font-bold mb-4 uppercase">Scalable Architecture</h3>
              <p className="text-on-surface-variant max-w-md">밀리초 단위의 지연 없이 대규모 트래픽을 처리하는 시스템을 설계합니다.</p>
            </div>
          </div>
          <div className="md:col-span-4 h-[400px] bg-surface-container-high p-12 flex flex-col justify-between border border-white/5">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-2 uppercase">Data Intelligence</h3>
              <p className="text-on-surface-variant text-sm">소비자 행동 데이터를 실질적인 비즈니스 성장 지표로 변환합니다.</p>
            </div>
          </div>
          <div className="md:col-span-4 h-[400px] bg-surface-container-high p-12 flex flex-col justify-between border border-white/5">
            <span className="material-symbols-outlined text-4xl text-primary">shopping_bag</span>
            <div>
              <h3 className="text-2xl font-bold mb-2 uppercase">Luxury Logistics</h3>
              <p className="text-on-surface-variant text-sm">글로벌 거점 간의 고부가가치 재고 흐름을 정교하게 제어합니다.</p>
            </div>
          </div>
          <div className="md:col-span-8 h-[400px] bg-surface-container border border-white/5 p-12 flex flex-col justify-end group cursor-pointer overflow-hidden relative">
            <img
            ...
            />
            <div className="relative z-10">
              <h3 className="text-3xl font-bold mb-4 uppercase">Premium UX Strategy</h3>
              <p className="text-on-surface-variant max-w-md">5성급 호텔 컨시어지 서비스를 경험하는 듯한 구매 여정을 설계합니다.</p>
            </div>
          </div>
        </div>
      </div>
